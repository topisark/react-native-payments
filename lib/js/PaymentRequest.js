...
export default class PaymentRequest {
  ...
  _handleUserAccept(details: {
    ...
    return this._acceptPromiseResolver && this._acceptPromiseResolver(paymentResponse);
  }

  _handleGatewayError(details: { error: string }) {
    return this._acceptPromiseRejecter && this._acceptPromiseRejecter(new GatewayError(details.error));
  }

  _closePaymentRequest() {
    this._state = 'closed';

    this._acceptPromiseRejecter && this._acceptPromiseRejecter(new Error('AbortError'));
